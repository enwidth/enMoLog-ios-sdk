#
#  Be sure to run `pod spec lint RLLogger.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/enwidth/enMoLog-ios-sdk.git"}
  ...
  # s.source_files  = "Classes", "RLLoggerSDKFramework/**/*.{h,m,swift}"
  s.source_files  = "Classes", "RLLoggerSDKFramework/**/*.{h,m,swift}"
